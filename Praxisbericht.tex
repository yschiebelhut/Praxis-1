...
% ---- Persönlichen Daten:
\newcommand{\titel}{Konzeptionierung und Implementierung einer verbesserten Version des Extended Warehouse Management Simulators}
\newcommand{\titelheader}{Rebuilt des EWM-Simulators}
...
\onehalfspacing
\include{Inhalt/04_Inhalt/01_einleitung}
\include{Inhalt/04_Inhalt/02_theoretischeGrundlagen}
\include{Inhalt/04_Inhalt/03_vorbereitung}
\include{Inhalt/04_Inhalt/04_implementierung}
\include{Inhalt/04_Inhalt/05_future.tex}
